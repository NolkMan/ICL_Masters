...
The other two hosts show when the Policy Maker is a bad tool to improve the sites security.
In those cases the reports generate much more traffic than what was needed to load the site.
...
% talk about malicious style detection
